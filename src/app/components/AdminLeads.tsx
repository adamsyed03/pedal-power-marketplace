                  ...
                  <tbody>{visibleLeads.map((lead) => {
                    ...
                    return (
                      <tr key={lead.id} className={`${rowTone} border-b border-slate-300 align-middle hover:bg-blue-50/70`}>
                        <td className="border-r border-slate-300 px-2 py-1.5"><div className="font-semibold text-slate-900">{lead.name}</div><div className="mt-0.5 text-[0.65rem] text-slate-400">{lead.language.toUpperCase()} · {submitted.toLocaleDateString('sr-RS')}</div></td>
