...
type PublicOrder = {
  ...
  items?: { product: string; name: string; quantity: number; unitPriceRsd: number; lineTotalRsd: number; originalUnitPriceRsd?: number; discountRsd?: number; promoCode?: string; gamePrizeLabel?: string }[];
