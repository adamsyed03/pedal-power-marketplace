  ...
  const ui = tr({
    ...
    ru: {
        ...
        technologyCards: [
          ...
          { title: 'Электрическая поддержка', body: 'Мотор мощностью 250 Вт в заднем колесе обеспечивает плавную и надёжную поддержку в городе' },
    ...
    },
    {
      ...
      points: tr({
        ...
        en: [
            ...
            'Hydraulic brakes',
            'Two batteries, up to 140 km range',
            'Fat tyre wheels',
            'GPS security features',
          ],
        ru: [
            ...
            'Две батареи, запас хода до 140 км',
